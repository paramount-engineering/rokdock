    ...
    ;(globalThis as unknown as { window: unknown }).window = {
        rokdock: {
            ai: {
                ...
                getDocSymbols: async () => ({}),
                onStreamChunk: (cb: ChunkCb) => { chunkCb = cb; return () => {} },
                onStreamDone: (cb: DoneCb) => { doneCb = cb; return () => {} },
                onStreamError: (cb: ErrCb) => { errCb = cb; return () => {} },
                onStreamActivity: (cb: ActivityCb) => { activityCb = cb; return () => {} },
            },
        },
    }
